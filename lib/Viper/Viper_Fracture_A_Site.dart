...
class Viper_Fracture_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Fracture_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Fracture_A_SiteState createState() => _Viper_Fracture_A_SiteState();
}

class _Viper_Fracture_A_SiteState extends State<Viper_Fracture_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("AA0ks4KScLU", "Fracture Viper A Site Setup 1"),
    VideoData("WIzgiqZgtbw", "Fracture Viper A Site Setup 2"),
    VideoData("Kt_x-BCl0w8", "Fracture Viper A Site Setup 3"),
    VideoData("CCeHO9PoaqY", "Fracture Viper A Site Setup 4"),
  ];
