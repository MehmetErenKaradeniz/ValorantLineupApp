...
class Viper_Abyss_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Abyss_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Abyss_A_SiteState createState() => _Viper_Abyss_A_SiteState();
}

class _Viper_Abyss_A_SiteState extends State<Viper_Abyss_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("AA0ks4KScLU", "Abyss Viper A Site Setup 1"),
    VideoData("WIzgiqZgtbw", "Abyss Viper A Site Setup 2"),
    VideoData("Kt_x-BCl0w8", "Abyss Viper A Site Setup 3"),
    VideoData("CCeHO9PoaqY", "Abyss Viper A Site Setup 4"),
  ];
