...
class Viper_Haven_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Haven_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Haven_B_SiteState createState() => _Viper_Haven_B_SiteState();
}

class _Viper_Haven_B_SiteState extends State<Viper_Haven_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("hZTcZUJnUWs", "Haven Viper B Site Setup 1"),
    VideoData("MSM4V3UoOI0", "Haven Viper B Site Setup 2"),
    VideoData("EfDvNkSNDJU", "Haven Viper B Site Setup 3"),
  ];
