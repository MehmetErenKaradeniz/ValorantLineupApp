...
class Viper_Bind_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Bind_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Bind_B_SiteState createState() => _Viper_Bind_B_SiteState();
}

class _Viper_Bind_B_SiteState extends State<Viper_Bind_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("TxmGWwo7ue8", "Bind Viper B Site Setup 1"),
    VideoData("Sdhwv6C8hLM", "Bind Viper B Site Setup 2"),
    VideoData("p2nlZHLpJUA", "Bind Viper B Site Setup 3"),
    VideoData("-O8oT0kmEkM", "Bind Viper B Site Setup 4"),
    VideoData("8nbeSKraUKA", "Bind Viper B Site Setup 5"),
    VideoData("Sdhwv6C8hLM", "Bind Viper B Site Setup 6"),
  ];
