...
class Viper_Split_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Split_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Split_A_SiteState createState() => _Viper_Split_A_SiteState();
}

class _Viper_Split_A_SiteState extends State<Viper_Split_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("ajk4cIFH4lc", "Split Viper A Site Setup 1"),
    VideoData("agsKB35J_xI", "Split Viper A Site Setup 2"),
    VideoData("LFVC1aB_jzk", "Split Viper A Site Setup 3"),
    VideoData("9VNHi-5gbtk", "Split Viper A Site Setup 4"),
  ];
