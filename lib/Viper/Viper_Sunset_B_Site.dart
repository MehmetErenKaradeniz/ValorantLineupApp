...
class Viper_Sunset_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Sunset_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Sunset_B_SiteState createState() => _Viper_Sunset_B_SiteState();
}

class _Viper_Sunset_B_SiteState extends State<Viper_Sunset_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("qLCrFCuzCjY", "Sunset Viper B Site Setup 1"),
    VideoData("yfWqvOmEYk8", "Sunset Viper B Site Setup 2"),
    VideoData("JsavZ-qh2TI", "Sunset Viper B Site Setup 3"),
  ];
