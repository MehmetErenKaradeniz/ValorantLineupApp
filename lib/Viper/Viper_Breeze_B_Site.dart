...
class Viper_Breeze_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Breeze_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Breeze_B_SiteState createState() => _Viper_Breeze_B_SiteState();
}

class _Viper_Breeze_B_SiteState extends State<Viper_Breeze_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("8rPEJSIR-PA", "Breeze Viper B Site Setup 1"),
    VideoData("okzAJn1ZVE4", "Breeze Viper B Site Setup 2"),
    VideoData("Inoeo6hcx3k", "Breeze Viper B Site Setup 3"),
    VideoData("QCk0YsZ90bU", "Breeze Viper B Site Setup 4"),
    VideoData("1BIC2XYwtEY", "Breeze Viper B Site Setup 5"),
    VideoData("27FtJOnw55c", "Breeze Viper B Site Setup 6"),
    VideoData("urCytZF4NWg", "Breeze Viper B Site Setup 7"),
  ];
