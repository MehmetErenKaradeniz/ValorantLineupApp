...
class Viper_Abyss_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Abyss_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Abyss_B_SiteState createState() => _Viper_Abyss_B_SiteState();
}

class _Viper_Abyss_B_SiteState extends State<Viper_Abyss_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("6wxl1WsB8_4", "Viper B Site Setup 1"),
    VideoData("0tox9bBpHn4", "Viper B Site Setup 2"),
    VideoData("vGy0Rgy7izQ", "Viper B Site Setup 3"),
    VideoData("IxgT07FXKuY", "Viper B Site Traps"),
  ];
