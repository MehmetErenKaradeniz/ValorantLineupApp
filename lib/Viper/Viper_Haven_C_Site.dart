...
class Viper_Haven_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Haven_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Haven_C_SiteState createState() => _Viper_Haven_C_SiteState();
}

class _Viper_Haven_C_SiteState extends State<Viper_Haven_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("QjBSgUu_tG4", "Haven Viper C Site Setup 1"),
    VideoData("dYBD7XJfBZk", "Haven Viper C Site Setup 2"),
    VideoData("mGKwFup-D0s", "Haven Viper C Site Setup 3"),
  ];
