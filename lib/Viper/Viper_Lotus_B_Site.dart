...
class Viper_Lotus_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Lotus_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Lotus_B_SiteState createState() => _Viper_Lotus_B_SiteState();
}

class _Viper_Lotus_B_SiteState extends State<Viper_Lotus_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("hZTcZUJnUWs", "Lotus Viper B Site Setup 1"),
    VideoData("MSM4V3UoOI0", "Lotus Viper B Site Setup 2"),
    VideoData("EfDvNkSNDJU", "Lotus Viper B Site Setup 3"),
  ];
