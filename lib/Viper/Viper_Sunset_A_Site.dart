...
class Viper_Sunset_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Sunset_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Sunset_A_SiteState createState() => _Viper_Sunset_A_SiteState();
}

class _Viper_Sunset_A_SiteState extends State<Viper_Sunset_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("QAhwubDrnkE", "Sunset Viper A Site Setup 1"),
    VideoData("sTYOQ3hFWb4", "Sunset Viper A Site Setup 2"),
    VideoData("2i5cezzxXXI", "Sunset Viper A Site Setup 3"),
    VideoData("Vrty3f2Uy_U", "Sunset Viper A Site Setup 4"),
  ];
