...
class Viper_Icebox_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Icebox_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Icebox_A_SiteState createState() => _Viper_Icebox_A_SiteState();
}

class _Viper_Icebox_A_SiteState extends State<Viper_Icebox_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("sIf4CKpMChE", "Icebox Viper A Site Setup 1"),
    VideoData("F6r7nwsJpvA", "Icebox Viper A Site Setup 2"),
    VideoData("fq8ZNQvNzdQ", "Icebox Viper A Site Setup 3"),
    VideoData("lFGX-OekTkw", "Icebox Viper A Site Setup 4"),
    VideoData("sMmZTJU6fGA", "Icebox Viper Mid Setup"),
  ];
