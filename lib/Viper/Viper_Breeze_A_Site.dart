...
class Viper_Breeze_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Viper_Breeze_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Viper_Breeze_A_SiteState createState() => _Viper_Breeze_A_SiteState();
}

class _Viper_Breeze_A_SiteState extends State<Viper_Breeze_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("bHKLi0f94JI", "Breeze Viper A Site Setup 1"),
    VideoData("XldJpFCT4qo", "Breeze Viper A Site Setup 2"),
    VideoData("9uZAMDKEJg0", "Breeze Viper A Site Setup 3"),
    VideoData("xMODj5a9sPE", "Breeze Viper A Site Setup 4"),
    VideoData("WUYxP2Y6rZc", "Breeze Viper A Site Setup 5"),
  ];
