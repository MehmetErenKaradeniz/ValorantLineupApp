...
class Killjoy_Haven_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Haven_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Haven_B_SiteState createState() => _Killjoy_Haven_B_SiteState();
}

class _Killjoy_Haven_B_SiteState extends State<Killjoy_Haven_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("hZTcZUJnUWs", "Haven Killjoy B Site Setup 1"),
    VideoData("MSM4V3UoOI0", "Haven Killjoy B Site Setup 2"),
    VideoData("EfDvNkSNDJU", "Haven Killjoy B Site Setup 3"),
  ];
