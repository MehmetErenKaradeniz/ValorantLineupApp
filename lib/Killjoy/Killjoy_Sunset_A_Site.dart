...
class Killjoy_Sunset_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Sunset_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Sunset_A_SiteState createState() => _Killjoy_Sunset_A_SiteState();
}

class _Killjoy_Sunset_A_SiteState extends State<Killjoy_Sunset_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("QAhwubDrnkE", "Sunset Killjoy A Site Setup 1"),
    VideoData("sTYOQ3hFWb4", "Sunset Killjoy A Site Setup 2"),
    VideoData("2i5cezzxXXI", "Sunset Killjoy A Site Setup 3"),
    VideoData("Vrty3f2Uy_U", "Sunset Killjoy A Site Setup 4"),
  ];
