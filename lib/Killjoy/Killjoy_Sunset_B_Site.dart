...
class Killjoy_Sunset_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Sunset_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Sunset_B_SiteState createState() => _Killjoy_Sunset_B_SiteState();
}

class _Killjoy_Sunset_B_SiteState extends State<Killjoy_Sunset_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("qLCrFCuzCjY", "Sunset Killjoy B Site Setup 1"),
    VideoData("yfWqvOmEYk8", "Sunset Killjoy B Site Setup 2"),
    VideoData("JsavZ-qh2TI", "Sunset Killjoy B Site Setup 3"),
  ];
