...
class Killjoy_Breeze_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Breeze_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Breeze_A_SiteState createState() => _Killjoy_Breeze_A_SiteState();
}

class _Killjoy_Breeze_A_SiteState extends State<Killjoy_Breeze_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("bHKLi0f94JI", "Breeze Killjoy A Site Setup 1"),
    VideoData("XldJpFCT4qo", "Breeze Killjoy A Site Setup 2"),
    VideoData("9uZAMDKEJg0", "Breeze Killjoy A Site Setup 3"),
    VideoData("xMODj5a9sPE", "Breeze Killjoy A Site Setup 4"),
    VideoData("WUYxP2Y6rZc", "Breeze Killjoy A Site Setup 5"),
  ];
