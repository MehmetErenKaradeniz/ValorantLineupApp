...
class Killjoy_Ascent_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Ascent_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Ascent_A_SiteState createState() => _Killjoy_Ascent_A_SiteState();
}

class _Killjoy_Ascent_A_SiteState extends State<Killjoy_Ascent_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("6wxl1WsB8_4", "Ascent Killjoy B Site Setup 1"),
    VideoData("0tox9bBpHn4", "Ascent Killjoy B Site Setup 2"),
    VideoData("vGy0Rgy7izQ", "Ascent Killjoy B Site Setup 3"),
    VideoData("IxgT07FXKuY", "Ascent Killjoy B Site Traps"),
  ];
