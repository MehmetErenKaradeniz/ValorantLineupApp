...
class Killjoy_Fracture_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Fracture_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Fracture_A_SiteState createState() => _Killjoy_Fracture_A_SiteState();
}

class _Killjoy_Fracture_A_SiteState extends State<Killjoy_Fracture_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("AA0ks4KScLU", "Fracture Killjoy A Site Setup 1"),
    VideoData("WIzgiqZgtbw", "Fracture Killjoy A Site Setup 2"),
    VideoData("Kt_x-BCl0w8", "Fracture Killjoy A Site Setup 3"),
    VideoData("CCeHO9PoaqY", "Fracture Killjoy A Site Setup 4"),
  ];
