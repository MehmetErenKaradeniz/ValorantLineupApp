...
class Killjoy_Split_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Split_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Split_B_SiteState createState() => _Killjoy_Split_B_SiteState();
}

class _Killjoy_Split_B_SiteState extends State<Killjoy_Split_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("jatDwxX0Lew", "Split Killjoy B Site Setup 1"),
    VideoData("IoZcR2CnDcc", "Split Killjoy B Site Setup 2"),
    VideoData("IzAxIwZxvr4", "Split Killjoy B Site Setup 3"),
    VideoData("YAgzSLXfE44", "Split Killjoy B Site Setup 4"),
    VideoData("_1ScmkJeh0s", "Split Killjoy B Site Setup 5"),
  ];
