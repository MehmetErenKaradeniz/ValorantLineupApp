...
class Killjoy_Bind_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Bind_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Bind_A_SiteState createState() => _Killjoy_Bind_A_SiteState();
}

class _Killjoy_Bind_A_SiteState extends State<Killjoy_Bind_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("4C1oQAd-IME", "Bind Killjoy A Site Setup 1"),
    VideoData("Quur68p8OK0", "Bind Killjoy A Site Setup 2"),
    VideoData("gbC9fZ_UJ60", "Bind Killjoy A Site Setup 3"),
    VideoData("f8AcW1LFahQ", "Bind Killjoy A Site Setup 4"),
  ];
