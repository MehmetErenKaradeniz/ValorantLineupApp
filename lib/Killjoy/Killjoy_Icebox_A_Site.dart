...
class Killjoy_Icebox_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Icebox_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Icebox_A_SiteState createState() => _Killjoy_Icebox_A_SiteState();
}

class _Killjoy_Icebox_A_SiteState extends State<Killjoy_Icebox_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("sIf4CKpMChE", "Icebox Killjoy A Site Setup 1"),
    VideoData("F6r7nwsJpvA", "Icebox Killjoy A Site Setup 2"),
    VideoData("fq8ZNQvNzdQ", "Icebox Killjoy A Site Setup 3"),
    VideoData("lFGX-OekTkw", "Icebox Killjoy A Site Setup 4"),
