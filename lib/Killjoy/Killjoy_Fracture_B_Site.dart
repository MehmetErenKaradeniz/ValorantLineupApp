...
class Killjoy_Fracture_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Fracture_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Fracture_B_SiteState createState() => _Killjoy_Fracture_B_SiteState();
}

class _Killjoy_Fracture_B_SiteState extends State<Killjoy_Fracture_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("6wxl1WsB8_4", "Fracture Killjoy B Site Setup 1"),
    VideoData("0tox9bBpHn4", "Fracture Killjoy B Site Setup 2"),
    VideoData("vGy0Rgy7izQ", "Fracture Killjoy B Site Setup 3"),
    VideoData("IxgT07FXKuY", "Fracture Killjoy B Site Traps"),
  ];
