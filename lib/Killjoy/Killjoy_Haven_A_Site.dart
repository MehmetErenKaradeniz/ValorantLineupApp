...
class Killjoy_Haven_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Haven_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Haven_A_SiteState createState() => _Killjoy_Haven_A_SiteState();
}

class _Killjoy_Haven_A_SiteState extends State<Killjoy_Haven_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("wPJWLE1aQjk", "Haven Killjoy A Site Setup 1"),
    VideoData("4l-G4LufPm4", "Haven Killjoy A Site Setup 2"),
    VideoData("3ZzOz9iBtiQ", "Haven Killjoy A Site Setup 3"),
  ];
