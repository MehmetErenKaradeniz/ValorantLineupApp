...
class Killjoy_Ascent_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Ascent_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Ascent_A_SiteState createState() => _Killjoy_Ascent_A_SiteState();
}

class _Killjoy_Ascent_A_SiteState extends State<Killjoy_Ascent_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("AA0ks4KScLU", "Ascent Killjoy A Site Setup 1"),
    VideoData("WIzgiqZgtbw", "Ascent Killjoy A Site Setup 2"),
    VideoData("Kt_x-BCl0w8", "Ascent Killjoy A Site Setup 3"),
    VideoData("CCeHO9PoaqY", "Ascent Killjoy A Site Setup 4"),
  ];
