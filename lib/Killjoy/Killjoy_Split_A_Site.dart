...
class Killjoy_Split_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Split_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Split_A_SiteState createState() => _Killjoy_Split_A_SiteState();
}

class _Killjoy_Split_A_SiteState extends State<Killjoy_Split_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("ajk4cIFH4lc", "Split Killjoy A Site Setup 1"),
    VideoData("agsKB35J_xI", "Split Killjoy A Site Setup 2"),
    VideoData("LFVC1aB_jzk", "Split Killjoy A Site Setup 3"),
    VideoData("9VNHi-5gbtk", "Split Killjoy A Site Setup 4"),
  ];
