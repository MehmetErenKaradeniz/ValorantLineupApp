...
class Killjoy_Lotus_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Lotus_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Lotus_C_SiteState createState() => _Killjoy_Lotus_C_SiteState();
}

class _Killjoy_Lotus_C_SiteState extends State<Killjoy_Lotus_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("QjBSgUu_tG4", "Lotus Killjoy C Site Setup 1"),
    VideoData("dYBD7XJfBZk", "Lotus Killjoy C Site Setup 2"),
    VideoData("mGKwFup-D0s", "Lotus Killjoy C Site Setup 3"),
  ];
