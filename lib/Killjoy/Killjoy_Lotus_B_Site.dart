...
class Killjoy_Lotus_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Killjoy_Lotus_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Killjoy_Lotus_B_SiteState createState() => _Killjoy_Lotus_B_SiteState();
}

class _Killjoy_Lotus_B_SiteState extends State<Killjoy_Lotus_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("hZTcZUJnUWs", "Lotus Killjoy B Site Setup 1"),
    VideoData("MSM4V3UoOI0", "Lotus Killjoy B Site Setup 2"),
    VideoData("EfDvNkSNDJU", "Lotus Killjoy B Site Setup 3"),
  ];
