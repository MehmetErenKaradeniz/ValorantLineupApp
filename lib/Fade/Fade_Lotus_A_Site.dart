...
class Fade_Lotus_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Lotus_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Lotus_A_SiteState createState() => _Fade_Lotus_A_SiteState();
}

class _Fade_Lotus_A_SiteState extends State<Fade_Lotus_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("LYA--XQ27gU", "Lotus Fade A Main to A Default Post Plant Lineup"),
    VideoData("x7kVgMmp2H8", "Lotus Fade A Main to A Site Recon Dart"),
    VideoData("vniMwInf3JU", "Lotus Fade B Main to A Site Fake Recon Dart"),
