...
class Fade_Lotus_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Lotus_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Lotus_B_SiteState createState() => _Fade_Lotus_B_SiteState();
}

class _Fade_Lotus_B_SiteState extends State<Fade_Lotus_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("EQjpu3CNeao", "Lotus Fade B Main to B Default Post Plant Lineup"),
    VideoData("YvUHseKTNYw", "Lotus Fade Spawn to B Site Recon Dart"),
    VideoData("3VRCQbSytP4", "Lotus Fade B Main to B Site Recon Dart"),
