...
class Fade_Breeze_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Breeze_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Breeze_B_SiteState createState() => _Fade_Breeze_B_SiteState();
}

class _Fade_Breeze_B_SiteState extends State<Fade_Breeze_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("-KCqRSMY454","Breeze Fade B Main to B Default Post Plant Lineup"),
    VideoData("c-y6x23hvaU","Breeze Fade B Main to B Site Enter Right Corner Control and Damage Shock Dart"),
    VideoData("c-y6x23hvaU","Breeze Fade B Window to B Site Enter Left Corner Control and Damage Shock Dart"),
    VideoData("zlD2kL0yVvQ","Breeze Fade B Main to A Tunnel Shock Dart Chamber Trap Break"),
    VideoData("W3ITs9KTnbQ","Breeze Fade B Main to B Site Recon Dart"),
    VideoData("8tXFyQfdYuE","Breeze Fade B Main to B Site Recon Dart 2"),
    VideoData("q4PD2UFASMw","Breeze Fade B Window to B Site Recon Dart"),
    VideoData("-uN8_w0Xv-Y","Breeze Fade Near B Window to A Site Fake Recon Dart"),
