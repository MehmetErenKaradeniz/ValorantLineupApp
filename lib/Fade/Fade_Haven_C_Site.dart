...
class Fade_Haven_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Haven_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Haven_C_SiteState createState() => _Fade_Haven_C_SiteState();
}

class _Fade_Haven_C_SiteState extends State<Fade_Haven_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("QjBSgUu_tG4", "Haven Fade C Site Setup 1"),
    VideoData("dYBD7XJfBZk", "Haven Fade C Site Setup 2"),
    VideoData("mGKwFup-D0s", "Haven Fade C Site Setup 3"),
  ];
