...
class Fade_Lotus_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Lotus_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Lotus_C_SiteState createState() => _Fade_Lotus_C_SiteState();
}

class _Fade_Lotus_C_SiteState extends State<Fade_Lotus_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("ar545ECEth8", "Lotus Fade C Main to C Open Long Post Plant Lineup"),
    VideoData("nSz5AEh-FZs", "Lotus Fade C Main to C Site Close Control Recon Dart"),
