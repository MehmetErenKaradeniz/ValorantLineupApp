...
class Fade_Haven_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Haven_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Haven_B_SiteState createState() => _Fade_Haven_B_SiteState();
}

class _Fade_Haven_B_SiteState extends State<Fade_Haven_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("hZTcZUJnUWs", "Haven Fade B Site Setup 1"),
    VideoData("MSM4V3UoOI0", "Haven Fade B Site Setup 2"),
    VideoData("EfDvNkSNDJU", "Haven Fade B Site Setup 3"),
  ];
