...
class Fade_Sunset_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Sunset_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Sunset_A_SiteState createState() => _Fade_Sunset_A_SiteState();
}

class _Fade_Sunset_A_SiteState extends State<Fade_Sunset_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("EEQkGiJ_d1I", "Sunset Fade A Main to A Default Post Plant Lineup(1x2box)"),
    VideoData("CBre-SFF7dA", "Sunset Fade A Main to A Post Plant Lineup(2x2box) 1"),
    VideoData("1wB-GEziKbk", "Sunset Fade A Main to A Post Plant Lineup(2x2box) 2"),
    VideoData("IOT04Fpq1-k", "Sunset Fade Defender A Enter to B Post Plant Lineup(2x2box)"),
    VideoData("ZkvHfa6E5-s", "Sunset Fade A Main to A Site Recon Dart"),
    VideoData("I812iwHGUw4", "Sunset Fade A Main to A Site Recon Darts"),
