...
class Fade_Bind_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Bind_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Bind_B_SiteState createState() => _Fade_Bind_B_SiteState();
}

class _Fade_Bind_B_SiteState extends State<Fade_Bind_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("UTzcXR5HM-4", "Ascent Fade B Site Default Post Plant Lineup"),
    VideoData("wNobAd8ckTQ", "Ascent Fade B to A Default Double Shock Dart Lineup"),
    VideoData("pHwmNGg6cIM", "Ascent Fade Fountain to Side Backsite Recon Dart"),
    VideoData("v_-vgRC79tE", "Ascent Fade Fountain to Side Backsite Recon Dart 2"),
    VideoData("Xac8JP-V_3Q", "Ascent Fade B TP Open Recon/Shock Dart"),
  ];
