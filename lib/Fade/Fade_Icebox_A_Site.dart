...
class Fade_Icebox_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Icebox_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Icebox_A_SiteState createState() => _Fade_Icebox_A_SiteState();
}

class _Fade_Icebox_A_SiteState extends State<Fade_Icebox_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("f5ZZedPa_Bc","Icebox Fade A Main to A Default Post Plant Lineup"),
    VideoData("ow0787KgN2A","Icebox Fade A Main to A Site Recon Dart"),
    VideoData("YuCD1zMskLM","Icebox Fade A Main to A Site Recon Dart 2"),
    VideoData("YuCD1zMskLM","Icebox Fade Spawm to Kitchen Recon Dart 3"),
    VideoData("wZcVa1Ks4F0","Icebox Fade A Main to Backsite B Fake Recon Dart"),
  ];
