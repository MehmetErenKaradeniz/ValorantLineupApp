...
class Fade_Split_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Split_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Split_B_SiteState createState() => _Fade_Split_B_SiteState();
}

class _Fade_Split_B_SiteState extends State<Fade_Split_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("cGmni8QNPS0", "Split Fade B Garage to B Default Post Plant Lineup"),
    VideoData("ta4TJ3GVAfs", "Split Fade B Main to B Default Post Plant Lineup"),
    VideoData("lqrIyTVGPtc", "Split Fade B Main to B Site Recon Dart"),
    VideoData("msDK6AmIuQA", "Split Fade B Main to B Site Recon Dart 2"),
    VideoData("zVUZxF8aRqU", "Split Fade B Main to B Site Recon Dart 3"),
    VideoData("ND1PXlHXx4o", "Split Fade B Main to B Site/Haven Recon Dart 4"),
