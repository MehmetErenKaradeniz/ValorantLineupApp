...
class Fade_Ascent_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Ascent_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Ascent_B_SiteState createState() => _Fade_Ascent_B_SiteState();
}

class _Fade_Ascent_B_SiteState extends State<Fade_Ascent_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("-RuvXgq-0Hw", "Ascent Fade B Site Default Post Plant Lineup"),
    VideoData("C8a6Gx0ywtI", "Ascent Fade B Site Default Post Plant Lineup 2"),
    VideoData("nhrW4MqZKRU", "Ascent Fade B Site Recon Dart"),
    VideoData("Y-__Tp2stNI", "Ascent Fade B Site Recon Dart 2"),
    VideoData("LVLe-m4RD1I", "Ascent Fade B Site Spawn to B Recon Dart 3"),
    VideoData("zgbXU70QnP0", "Ascent Fade B to A Recon Fake Recon Dart "),
    VideoData("yk1OXTy7hE4", "Ascent Fade B to A Recon Fake Recon Dart 2"),
  ];
