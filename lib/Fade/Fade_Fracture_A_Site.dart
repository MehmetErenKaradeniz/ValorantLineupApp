...
class Fade_Fracture_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Fade_Fracture_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Fade_Fracture_A_SiteState createState() => _Fade_Fracture_A_SiteState();
}

class _Fade_Fracture_A_SiteState extends State<Fade_Fracture_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("AA0ks4KScLU", "Fracture Fade A Site Setup 1"),
    VideoData("WIzgiqZgtbw", "Fracture Fade A Site Setup 2"),
    VideoData("Kt_x-BCl0w8", "Fracture Fade A Site Setup 3"),
    VideoData("CCeHO9PoaqY", "Fracture Fade A Site Setup 4"),
  ];
