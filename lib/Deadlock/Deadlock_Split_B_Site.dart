...
class Deadlock_Split_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Split_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Split_B_SiteState createState() => _Deadlock_Split_B_SiteState();
}

class _Deadlock_Split_B_SiteState extends State<Deadlock_Split_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("cGmni8QNPS0", "Split Deadlock B Garage to B Default Post Plant Lineup"),
    VideoData("ta4TJ3GVAfs", "Split Deadlock B Main to B Default Post Plant Lineup"),
    VideoData("lqrIyTVGPtc", "Split Deadlock B Main to B Site Recon Dart"),
    VideoData("msDK6AmIuQA", "Split Deadlock B Main to B Site Recon Dart 2"),
    VideoData("zVUZxF8aRqU", "Split Deadlock B Main to B Site Recon Dart 3"),
    VideoData("ND1PXlHXx4o", "Split Deadlock B Main to B Site/Haven Recon Dart 4"),
