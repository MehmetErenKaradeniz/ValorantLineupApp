...
class Deadlock_Split_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Split_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Split_A_SiteState createState() => _Deadlock_Split_A_SiteState();
}

class _Deadlock_Split_A_SiteState extends State<Deadlock_Split_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("1OF5iTUWDJE", "Split Deadlock A Main to A Site Post Plant Lineup"),
    VideoData("QDpczW3aLfo", "Split Deadlock A Main to A Site Back the Box Post Plant Lineup"),
    VideoData("k0DSmcvb9I0", "Split Deadlock A Main to A Site Open Spike for the Haven Post Plant Lineup"),
    VideoData("Uc6lEhNt3Q", "Split Deadlock A Main to A Site Recon Dart"),
    VideoData("kmJtLIf22UE", "Split Deadlock A Main to A Site Recon Dart 2"),
