...
class Deadlock_Lotus_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Lotus_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Lotus_A_SiteState createState() => _Deadlock_Lotus_A_SiteState();
}

class _Deadlock_Lotus_A_SiteState extends State<Deadlock_Lotus_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("LYA--XQ27gU", "Lotus Deadlock A Main to A Default Post Plant Lineup"),
    VideoData("x7kVgMmp2H8", "Lotus Deadlock A Main to A Site Recon Dart"),
    VideoData("vniMwInf3JU", "Lotus Deadlock B Main to A Site Fake Recon Dart"),
