...
class Deadlock_Sunset_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Sunset_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Sunset_B_SiteState createState() => _Deadlock_Sunset_B_SiteState();
}

class _Deadlock_Sunset_B_SiteState extends State<Deadlock_Sunset_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("pudlbk_aSfE", "Sunset Deadlock B Main to B Site Default Post Plant Lineup"),
    VideoData("uOEYi1LZt00", "Sunset Deadlock B Main to B Enter Cypher Trap Break"),
    VideoData("PLjVWy7OzHE", "Sunset Deadlock B Main to B Enter Cypher Trap Break 2"),
    VideoData("L-ZOe23FS_M", "Sunset Deadlock B Main to Mid Double Shock Dart"),
    VideoData("pBHBCGlw4Bs", "Sunset Deadlock B Main to B Backsite Recon Dart"),
    VideoData("Khfa0m5szTg", "Sunset Deadlock B Main to B Close Recon Dart"),
