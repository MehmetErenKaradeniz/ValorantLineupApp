...
class Deadlock_Bind_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Bind_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Bind_A_SiteState createState() => _Deadlock_Bind_A_SiteState();
}

class _Deadlock_Bind_A_SiteState extends State<Deadlock_Bind_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("psc7Q24HUJc", "Ascent Deadlock A Site Default Post Plant Lineup"),
    VideoData("zm_GxXjED1w", "Ascent Deadlock Box Post Plant Lineup"),
    VideoData("wNobAd8ckTQ", "Ascent Deadlock B to A Default Double Shock Dart Lineup"),
    VideoData("q8d8NrPIHyY", "Ascent Deadlock A Site Close Control Recon Dart"),
    VideoData("kqsd8jmBpzM", "Ascent Deadlock A Backsite Control Recon Dart 2"),
    VideoData("Y8qc1luHeAU", "Ascent Deadlock Base To A Backsite Recon Dart 3"),
  ];
