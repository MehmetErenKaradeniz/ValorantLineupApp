...
class Deadlock_Breeze_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Breeze_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Breeze_A_SiteState createState() => _Deadlock_Breeze_A_SiteState();
}

class _Deadlock_Breeze_A_SiteState extends State<Deadlock_Breeze_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("tNIfcbP1haw", "Breeze Deadlock A Site Default Post Plant Lineup"),
    VideoData("-j3d11nxfRQ", "Breeze Deadlock A Site Default Post Plant Lineup"),
    VideoData("LQL-uYDNd50", "Breeze Deadlock Shock Dart Tunnel Chamber Trap Break"),
    VideoData("acXEs1NUwZ4", "Breeze Deadlock A Back Site Control Recon Dart"),
    VideoData("eWsW-L61b8Q", "Breeze Deadlock A Site Recon Darts"),
    VideoData("Bxf2eNv--To", "Breeze Deadlock Mid to B Site Fake Recon Darts"),
    VideoData("JrF-Akn6Mb4", "Breeze Deadlock Mid to B Mid Door Info Recon Darts"),
    VideoData("pN1Quo7M-s4", "Breeze Deadlock A Tunnel to A Bridge Info Recon Darts"),
  ];
