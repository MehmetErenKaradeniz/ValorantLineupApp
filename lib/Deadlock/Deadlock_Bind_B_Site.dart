...
class Deadlock_Bind_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Bind_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Bind_B_SiteState createState() => _Deadlock_Bind_B_SiteState();
}

class _Deadlock_Bind_B_SiteState extends State<Deadlock_Bind_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("UTzcXR5HM-4", "Ascent Deadlock B Site Default Post Plant Lineup"),
    VideoData("wNobAd8ckTQ", "Ascent Deadlock B to A Default Double Shock Dart Lineup"),
    VideoData("pHwmNGg6cIM", "Ascent Deadlock Fountain to Side Backsite Recon Dart"),
    VideoData("v_-vgRC79tE", "Ascent Deadlock Fountain to Side Backsite Recon Dart 2"),
    VideoData("Xac8JP-V_3Q", "Ascent Deadlock B TP Open Recon/Shock Dart"),
  ];
