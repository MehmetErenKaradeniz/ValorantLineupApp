...
class Deadlock_Breeze_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Breeze_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Breeze_B_SiteState createState() => _Deadlock_Breeze_B_SiteState();
}

class _Deadlock_Breeze_B_SiteState extends State<Deadlock_Breeze_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("-KCqRSMY454","Breeze Deadlock B Main to B Default Post Plant Lineup"),
    VideoData("c-y6x23hvaU","Breeze Deadlock B Main to B Site Enter Right Corner Control and Damage Shock Dart"),
    VideoData("c-y6x23hvaU","Breeze Deadlock B Window to B Site Enter Left Corner Control and Damage Shock Dart"),
    VideoData("zlD2kL0yVvQ","Breeze Deadlock B Main to A Tunnel Shock Dart Chamber Trap Break"),
    VideoData("W3ITs9KTnbQ","Breeze Deadlock B Main to B Site Recon Dart"),
    VideoData("8tXFyQfdYuE","Breeze Deadlock B Main to B Site Recon Dart 2"),
    VideoData("q4PD2UFASMw","Breeze Deadlock B Window to B Site Recon Dart"),
    VideoData("-uN8_w0Xv-Y","Breeze Deadlock Near B Window to A Site Fake Recon Dart"),
