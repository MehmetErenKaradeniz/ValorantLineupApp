...
class Deadlock_Haven_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Haven_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Haven_B_SiteState createState() => _Deadlock_Haven_B_SiteState();
}

class _Deadlock_Haven_B_SiteState extends State<Deadlock_Haven_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("hZTcZUJnUWs", "Haven Deadlock B Site Setup 1"),
    VideoData("MSM4V3UoOI0", "Haven Deadlock B Site Setup 2"),
    VideoData("EfDvNkSNDJU", "Haven Deadlock B Site Setup 3"),
  ];
