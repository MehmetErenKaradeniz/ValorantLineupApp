...
class Deadlock_Lotus_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Lotus_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Lotus_B_SiteState createState() => _Deadlock_Lotus_B_SiteState();
}

class _Deadlock_Lotus_B_SiteState extends State<Deadlock_Lotus_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("EQjpu3CNeao", "Lotus Deadlock B Main to B Default Post Plant Lineup"),
    VideoData("YvUHseKTNYw", "Lotus Deadlock Spawn to B Site Recon Dart"),
    VideoData("3VRCQbSytP4", "Lotus Deadlock B Main to B Site Recon Dart"),
