...
class Deadlock_Sunset_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Sunset_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Sunset_A_SiteState createState() => _Deadlock_Sunset_A_SiteState();
}

class _Deadlock_Sunset_A_SiteState extends State<Deadlock_Sunset_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("EEQkGiJ_d1I", "Sunset Deadlock A Main to A Default Post Plant Lineup(1x2box)"),
    VideoData("CBre-SFF7dA", "Sunset Deadlock A Main to A Post Plant Lineup(2x2box) 1"),
    VideoData("1wB-GEziKbk", "Sunset Deadlock A Main to A Post Plant Lineup(2x2box) 2"),
    VideoData("IOT04Fpq1-k", "Sunset Deadlock Defender A Enter to B Post Plant Lineup(2x2box)"),
    VideoData("ZkvHfa6E5-s", "Sunset Deadlock A Main to A Site Recon Dart"),
    VideoData("I812iwHGUw4", "Sunset Deadlock A Main to A Site Recon Darts"),
