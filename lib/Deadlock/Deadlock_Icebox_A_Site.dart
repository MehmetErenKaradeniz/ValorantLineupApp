...
class Deadlock_Icebox_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Icebox_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Icebox_A_SiteState createState() => _Deadlock_Icebox_A_SiteState();
}

class _Deadlock_Icebox_A_SiteState extends State<Deadlock_Icebox_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("f5ZZedPa_Bc","Icebox Deadlock A Main to A Default Post Plant Lineup"),
    VideoData("ow0787KgN2A","Icebox Deadlock A Main to A Site Recon Dart"),
    VideoData("YuCD1zMskLM","Icebox Deadlock A Main to A Site Recon Dart 2"),
    VideoData("YuCD1zMskLM","Icebox Deadlock Spawm to Kitchen Recon Dart 3"),
    VideoData("wZcVa1Ks4F0","Icebox Deadlock A Main to Backsite B Fake Recon Dart"),
  ];
