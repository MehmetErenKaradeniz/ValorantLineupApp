...
class Deadlock_Haven_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Haven_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Haven_C_SiteState createState() => _Deadlock_Haven_C_SiteState();
}

class _Deadlock_Haven_C_SiteState extends State<Deadlock_Haven_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("QjBSgUu_tG4", "Haven Deadlock C Site Setup 1"),
    VideoData("dYBD7XJfBZk", "Haven Deadlock C Site Setup 2"),
    VideoData("mGKwFup-D0s", "Haven Deadlock C Site Setup 3"),
  ];
