...
class Deadlock_Icebox_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Icebox_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Icebox_B_SiteState createState() => _Deadlock_Icebox_B_SiteState();
}

class _Deadlock_Icebox_B_SiteState extends State<Deadlock_Icebox_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("UBYdgqIvAvY","Icebox Deadlock B Main to Default Post Plant Lineup"),
    VideoData("3cwzgYQANcw","Icebox Deadlock B Main to Open Long Post Plant Lineup"),
    VideoData("v_SR-mOgopc","Icebox Deadlock Spawn to B Long Overpeek check Shock Dart"),
    VideoData("YuCD1zMskLM","Icebox Deadlock Spawm to Kitchen Recon Dart"),
    VideoData("oY9y050_oek","Icebox Deadlock B Main to B Site Recon Dart"),
    VideoData("n_g9gMns7Uc","Icebox Deadlock B Main to B Site Close Control Recon Dart"),
  ];
