...
class Deadlock_Lotus_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Lotus_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Lotus_C_SiteState createState() => _Deadlock_Lotus_C_SiteState();
}

class _Deadlock_Lotus_C_SiteState extends State<Deadlock_Lotus_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("ar545ECEth8", "Lotus Deadlock C Main to C Open Long Post Plant Lineup"),
    VideoData("nSz5AEh-FZs", "Lotus Deadlock C Main to C Site Close Control Recon Dart"),
