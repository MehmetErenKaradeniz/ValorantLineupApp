...
class Deadlock_Ascent_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Deadlock_Ascent_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Deadlock_Ascent_A_SiteState createState() => _Deadlock_Ascent_A_SiteState();
}

class _Deadlock_Ascent_A_SiteState extends State<Deadlock_Ascent_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("k4_rVTthzLg", "Ascent Deadlock A Main to A Default Post Plant Lineup"),
    VideoData("BURUf_1yaBw", "Ascent Deadlock Wine to A Default Post Plant Lineup"),
    VideoData("RXEmp47eovM", "Ascent Deadlock Wine to A Double Box Post Plant Lineup"),
    VideoData("6Gli8PIwpTc", "Ascent Deadlock Generator Check Shock Dart"),
    VideoData("75TLedx4HWI", "Ascent Deadlock A Site Recon Dart"),
    VideoData("7UGqui8odgU", "Ascent Deadlock A Site Recon Dart 2"),
    VideoData("j3k3jmpMQ_E", "Ascent Deadlock A Site Recon Dart 3"),
    VideoData("oluRtvkWIrg", "Ascent Deadlock A Main to B Fake Recon Dart"),
    VideoData("2C55PQ_PXLA", "Ascent Deadlock Top Mid(base) to B Fake Recon Dart 2"),
    VideoData("LVLe-m4RD1I", "Ascent Deadlock Spawn to B Fake Recon Dart 3"),
  ];
