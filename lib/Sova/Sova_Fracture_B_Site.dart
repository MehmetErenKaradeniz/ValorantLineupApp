...
class Sova_Fracture_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Sova_Fracture_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Sova_Fracture_B_SiteState createState() => _Sova_Fracture_B_SiteState();
}

class _Sova_Fracture_B_SiteState extends State<Sova_Fracture_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("6wxl1WsB8_4", "Fracture Sova B Site Setup 1"),
    VideoData("0tox9bBpHn4", "Fracture Sova B Site Setup 2"),
    VideoData("vGy0Rgy7izQ", "Fracture Sova B Site Setup 3"),
    VideoData("IxgT07FXKuY", "Fracture Sova B Site Traps"),
  ];
