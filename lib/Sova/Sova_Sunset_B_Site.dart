...
class Sova_Sunset_B_Site extends StatefulWidget {
  final Agents agent;
  final MapsData map;
  final SiteData site;

  Sova_Sunset_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Sova_Sunset_B_SiteState createState() => _Sova_Sunset_B_SiteState();
}
