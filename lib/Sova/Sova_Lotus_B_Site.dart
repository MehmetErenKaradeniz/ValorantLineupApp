...
class Sova_Lotus_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Sova_Lotus_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Sova_Lotus_B_SiteState createState() => _Sova_Lotus_B_SiteState();
}

class _Sova_Lotus_B_SiteState extends State<Sova_Lotus_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("EQjpu3CNeao", "Lotus Sova B Main to B Default Post Plant Lineup"),
    VideoData("YvUHseKTNYw", "Lotus Sova Spawn to B Site Recon Dart"),
    VideoData("3VRCQbSytP4", "Lotus Sova B Main to B Site Recon Dart"),
