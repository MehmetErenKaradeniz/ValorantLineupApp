...
class Sova_Haven_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Sova_Haven_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Sova_Haven_C_SiteState createState() => _Sova_Haven_C_SiteState();
}

class _Sova_Haven_C_SiteState extends State<Sova_Haven_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("QjBSgUu_tG4", "Haven Sova C Site Setup 1"),
    VideoData("dYBD7XJfBZk", "Haven Sova C Site Setup 2"),
    VideoData("mGKwFup-D0s", "Haven Sova C Site Setup 3"),
  ];
