...
class Sova_Haven_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Sova_Haven_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Sova_Haven_B_SiteState createState() => _Sova_Haven_B_SiteState();
}

class _Sova_Haven_B_SiteState extends State<Sova_Haven_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("hZTcZUJnUWs", "Haven Sova B Site Setup 1"),
    VideoData("MSM4V3UoOI0", "Haven Sova B Site Setup 2"),
    VideoData("EfDvNkSNDJU", "Haven Sova B Site Setup 3"),
  ];
