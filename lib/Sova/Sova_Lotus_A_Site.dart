...
class Sova_Lotus_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Sova_Lotus_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Sova_Lotus_A_SiteState createState() => _Sova_Lotus_A_SiteState();
}
