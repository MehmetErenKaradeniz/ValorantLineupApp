...
class Sova_Pearl_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Sova_Pearl_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Sova_Pearl_B_SiteState createState() => _Sova_Pearl_B_SiteState();
}

class _Sova_Pearl_B_SiteState extends State<Sova_Pearl_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("6wxl1WsB8_4", "Pearl Sova B Site Setup 1"),
    VideoData("0tox9bBpHn4", "Pearl Sova B Site Setup 2"),
    VideoData("vGy0Rgy7izQ", "Pearl Sova B Site Setup 3"),
    VideoData("IxgT07FXKuY", "Pearl Sova B Site Traps"),
  ];
