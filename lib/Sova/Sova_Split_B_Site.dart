...
class Sova_Split_B_Site extends StatefulWidget {
  final Agents agent;
  final MapsData map;
  final SiteData site;

  Sova_Split_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Sova_Split_B_SiteState createState() => _Sova_Split_B_SiteState();
}
