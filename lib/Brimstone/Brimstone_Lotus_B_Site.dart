...
class Brimstone_Lotus_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Lotus_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Lotus_B_SiteState createState() => _Brimstone_Lotus_B_SiteState();
}

class _Brimstone_Lotus_B_SiteState extends State<Brimstone_Lotus_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("hZTcZUJnUWs", "Lotus Brimstone B Site Setup 1"),
    VideoData("MSM4V3UoOI0", "Lotus Brimstone B Site Setup 2"),
    VideoData("EfDvNkSNDJU", "Lotus Brimstone B Site Setup 3"),
  ];
