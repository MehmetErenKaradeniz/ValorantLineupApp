...
class Brimstone_Sunset_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Sunset_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Sunset_B_SiteState createState() => _Brimstone_Sunset_B_SiteState();
}

class _Brimstone_Sunset_B_SiteState extends State<Brimstone_Sunset_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("qLCrFCuzCjY", "Sunset Brimstone B Site Setup 1"),
    VideoData("yfWqvOmEYk8", "Sunset Brimstone B Site Setup 2"),
    VideoData("JsavZ-qh2TI", "Sunset Brimstone B Site Setup 3"),
  ];
