...
class Brimstone_Abyss_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Abyss_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Abyss_A_SiteState createState() => _Brimstone_Abyss_A_SiteState();
}

class _Brimstone_Abyss_A_SiteState extends State<Brimstone_Abyss_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("AA0ks4KScLU", "Abyss Brimstone A Site Setup 1"),
    VideoData("WIzgiqZgtbw", "Abyss Brimstone A Site Setup 2"),
    VideoData("Kt_x-BCl0w8", "Abyss Brimstone A Site Setup 3"),
    VideoData("CCeHO9PoaqY", "Abyss Brimstone A Site Setup 4"),
  ];
