...
class Brimstone_Icebox_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Icebox_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Icebox_A_SiteState createState() => _Brimstone_Icebox_A_SiteState();
}

class _Brimstone_Icebox_A_SiteState extends State<Brimstone_Icebox_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("sIf4CKpMChE", "Icebox Brimstone A Site Setup 1"),
    VideoData("F6r7nwsJpvA", "Icebox Brimstone A Site Setup 2"),
    VideoData("fq8ZNQvNzdQ", "Icebox Brimstone A Site Setup 3"),
    VideoData("lFGX-OekTkw", "Icebox Brimstone A Site Setup 4"),
