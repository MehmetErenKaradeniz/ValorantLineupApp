...
class Brimstone_Split_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Split_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Split_B_SiteState createState() => _Brimstone_Split_B_SiteState();
}

class _Brimstone_Split_B_SiteState extends State<Brimstone_Split_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("jatDwxX0Lew", "Split Brimstone B Site Setup 1"),
    VideoData("IoZcR2CnDcc", "Split Brimstone B Site Setup 2"),
    VideoData("IzAxIwZxvr4", "Split Brimstone B Site Setup 3"),
    VideoData("YAgzSLXfE44", "Split Brimstone B Site Setup 4"),
    VideoData("_1ScmkJeh0s", "Split Brimstone B Site Setup 5"),
  ];
