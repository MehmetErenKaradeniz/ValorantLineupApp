...
class Brimstone_Icebox_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Icebox_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Icebox_B_SiteState createState() => _Brimstone_Icebox_B_SiteState();
}

class _Brimstone_Icebox_B_SiteState extends State<Brimstone_Icebox_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("4TNAJ9r18o8", "Icebox Brimstone B Site Setup 1"),
    VideoData("fIS7M011zIQ", "Icebox Brimstone B Site Setup 2"),
    VideoData("HsKLI0Tv2K0", "Icebox Brimstone B Site Setup 3"),
    VideoData("OvQcs5ymfwg", "Icebox Brimstone B Site Setup 4"),
    VideoData("sMmZTJU6fGA", "Icebox Brimstone Mid Setup"),
  ];
