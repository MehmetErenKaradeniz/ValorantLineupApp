...
class Brimstone_Split_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Split_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Split_A_SiteState createState() => _Brimstone_Split_A_SiteState();
}

class _Brimstone_Split_A_SiteState extends State<Brimstone_Split_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("ajk4cIFH4lc", "Split Brimstone A Site Setup 1"),
    VideoData("agsKB35J_xI", "Split Brimstone A Site Setup 2"),
    VideoData("LFVC1aB_jzk", "Split Brimstone A Site Setup 3"),
    VideoData("9VNHi-5gbtk", "Split Brimstone A Site Setup 4"),
  ];
