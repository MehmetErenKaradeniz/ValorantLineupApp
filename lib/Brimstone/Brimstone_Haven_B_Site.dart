...
class Brimstone_Haven_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Haven_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Haven_B_SiteState createState() => _Brimstone_Haven_B_SiteState();
}

class _Brimstone_Haven_B_SiteState extends State<Brimstone_Haven_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("hZTcZUJnUWs", "Haven Brimstone B Site Setup 1"),
    VideoData("MSM4V3UoOI0", "Haven Brimstone B Site Setup 2"),
    VideoData("EfDvNkSNDJU", "Haven Brimstone B Site Setup 3"),
  ];
