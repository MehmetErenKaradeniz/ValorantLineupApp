...
class Brimstone_Breeze_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Breeze_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Breeze_A_SiteState createState() => _Brimstone_Breeze_A_SiteState();
}

class _Brimstone_Breeze_A_SiteState extends State<Brimstone_Breeze_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("bHKLi0f94JI", "Breeze Brimstone A Site Setup 1"),
    VideoData("XldJpFCT4qo", "Breeze Brimstone A Site Setup 2"),
    VideoData("9uZAMDKEJg0", "Breeze Brimstone A Site Setup 3"),
    VideoData("xMODj5a9sPE", "Breeze Brimstone A Site Setup 4"),
    VideoData("WUYxP2Y6rZc", "Breeze Brimstone A Site Setup 5"),
  ];
