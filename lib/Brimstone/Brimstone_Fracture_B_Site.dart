...
class Brimstone_Fracture_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Fracture_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Fracture_B_SiteState createState() => _Brimstone_Fracture_B_SiteState();
}

class _Brimstone_Fracture_B_SiteState extends State<Brimstone_Fracture_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("6wxl1WsB8_4", "Fracture Brimstone B Site Setup 1"),
    VideoData("0tox9bBpHn4", "Fracture Brimstone B Site Setup 2"),
    VideoData("vGy0Rgy7izQ", "Fracture Brimstone B Site Setup 3"),
    VideoData("IxgT07FXKuY", "Fracture Brimstone B Site Traps"),
  ];
