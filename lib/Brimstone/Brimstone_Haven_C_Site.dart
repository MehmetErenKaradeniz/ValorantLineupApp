...
class Brimstone_Haven_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Haven_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Haven_C_SiteState createState() => _Brimstone_Haven_C_SiteState();
}

class _Brimstone_Haven_C_SiteState extends State<Brimstone_Haven_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("QjBSgUu_tG4", "Haven Brimstone C Site Setup 1"),
    VideoData("dYBD7XJfBZk", "Haven Brimstone C Site Setup 2"),
    VideoData("mGKwFup-D0s", "Haven Brimstone C Site Setup 3"),
  ];
