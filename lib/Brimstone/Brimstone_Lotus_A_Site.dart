...
class Brimstone_Lotus_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Lotus_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Lotus_A_SiteState createState() => _Brimstone_Lotus_A_SiteState();
}

class _Brimstone_Lotus_A_SiteState extends State<Brimstone_Lotus_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("wPJWLE1aQjk", "Lotus Brimstone A Site Setup 1"),
    VideoData("4l-G4LufPm4", "Lotus Brimstone A Site Setup 2"),
    VideoData("3ZzOz9iBtiQ", "Lotus Brimstone A Site Setup 3"),
  ];
