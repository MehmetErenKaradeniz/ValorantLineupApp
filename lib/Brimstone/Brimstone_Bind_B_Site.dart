...
class Brimstone_Bind_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Bind_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Bind_B_SiteState createState() => _Brimstone_Bind_B_SiteState();
}

class _Brimstone_Bind_B_SiteState extends State<Brimstone_Bind_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("TxmGWwo7ue8", "Bind Brimstone B Site Setup 1"),
    VideoData("Sdhwv6C8hLM", "Bind Brimstone B Site Setup 2"),
    VideoData("p2nlZHLpJUA", "Bind Brimstone B Site Setup 3"),
    VideoData("-O8oT0kmEkM", "Bind Brimstone B Site Setup 4"),
    VideoData("8nbeSKraUKA", "Bind Brimstone B Site Setup 5"),
    VideoData("Sdhwv6C8hLM", "Bind Brimstone B Site Setup 6"),
  ];
