...
class Brimstone_Lotus_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Lotus_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Lotus_C_SiteState createState() => _Brimstone_Lotus_C_SiteState();
}

class _Brimstone_Lotus_C_SiteState extends State<Brimstone_Lotus_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("QjBSgUu_tG4", "Lotus Brimstone C Site Setup 1"),
    VideoData("dYBD7XJfBZk", "Lotus Brimstone C Site Setup 2"),
    VideoData("mGKwFup-D0s", "Lotus Brimstone C Site Setup 3"),
  ];
