...
class Brimstone_Ascent_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Ascent_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Ascent_A_SiteState createState() => _Brimstone_Ascent_A_SiteState();
}

class _Brimstone_Ascent_A_SiteState extends State<Brimstone_Ascent_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("6wxl1WsB8_4", "Ascent Brimstone B Site Setup 1"),
    VideoData("0tox9bBpHn4", "Ascent Brimstone B Site Setup 2"),
    VideoData("vGy0Rgy7izQ", "Ascent Brimstone B Site Setup 3"),
    VideoData("IxgT07FXKuY", "Ascent Brimstone B Site Traps"),
  ];
