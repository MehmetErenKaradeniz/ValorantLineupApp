...
class Brimstone_Breeze_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Brimstone_Breeze_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Brimstone_Breeze_B_SiteState createState() => _Brimstone_Breeze_B_SiteState();
}

class _Brimstone_Breeze_B_SiteState extends State<Brimstone_Breeze_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("8rPEJSIR-PA", "Breeze Brimstone B Site Setup 1"),
    VideoData("okzAJn1ZVE4", "Breeze Brimstone B Site Setup 2"),
    VideoData("Inoeo6hcx3k", "Breeze Brimstone B Site Setup 3"),
    VideoData("QCk0YsZ90bU", "Breeze Brimstone B Site Setup 4"),
    VideoData("1BIC2XYwtEY", "Breeze Brimstone B Site Setup 5"),
    VideoData("27FtJOnw55c", "Breeze Brimstone B Site Setup 6"),
    VideoData("urCytZF4NWg", "Breeze Brimstone B Site Setup 7"),
  ];
