...
class Cypher_Ascent_A_Site extends StatefulWidget {
  final Agents agent;
  final MapsData map;
  final SiteData site;

  Cypher_Ascent_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Cypher_Ascent_A_SiteState createState() => _Cypher_Ascent_A_SiteState();
}

class _Cypher_Ascent_A_SiteState extends State<Cypher_Ascent_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("03Ie2ZiRkAQ", "Sova Default Post Plant Lineup"),
