...
class Cypher_Sunset_B_Site extends StatefulWidget {
  final Agents agent;
  final MapsData map;
  final SiteData site;

  Cypher_Sunset_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Cypher_Sunset_B_SiteState createState() => _Cypher_Sunset_B_SiteState();
}

class _Cypher_Sunset_B_SiteState extends State<Cypher_Sunset_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("qLCrFCuzCjY", "Sunset Cypher B Site Setup 1"),
    VideoData("yfWqvOmEYk8", "Sunset Cypher B Site Setup 2"),
    VideoData("JsavZ-qh2TI", "Sunset Cypher B Site Setup 3"),
  ];
