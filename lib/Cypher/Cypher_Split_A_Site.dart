...
class Cypher_Split_A_Site extends StatefulWidget {
  final Agents agent;
  final MapsData map;
  final SiteData site;

  Cypher_Split_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Cypher_Split_A_SiteState createState() => _Cypher_Split_A_SiteState();
}
