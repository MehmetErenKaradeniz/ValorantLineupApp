...
class Cypher_Haven_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Cypher_Haven_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Cypher_Haven_A_SiteState createState() => _Cypher_Haven_A_SiteState();
}

class _Cypher_Haven_A_SiteState extends State<Cypher_Haven_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("wPJWLE1aQjk", "Lotus Cypher A Site Setup 1"),
    VideoData("4l-G4LufPm4", "Lotus Cypher A Site Setup 2"),
    VideoData("3ZzOz9iBtiQ", "Lotus Cypher A Site Setup 3"),
  ];
