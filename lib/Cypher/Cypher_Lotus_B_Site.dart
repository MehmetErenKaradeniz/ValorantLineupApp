...
class Cypher_Lotus_B_Site extends StatefulWidget {
  final Agents agent;
  final MapsData map;
  final SiteData site;

  Cypher_Lotus_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Cypher_Lotus_B_SiteState createState() => _Cypher_Lotus_B_SiteState();
}
