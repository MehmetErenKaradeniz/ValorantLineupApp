...
class Cypher_Fracture_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Cypher_Fracture_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Cypher_Fracture_B_SiteState createState() => _Cypher_Fracture_B_SiteState();
}

class _Cypher_Fracture_B_SiteState extends State<Cypher_Fracture_B_Site> {
