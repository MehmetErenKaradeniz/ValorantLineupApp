...
class Cypher_Icebox_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Cypher_Icebox_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Cypher_Icebox_B_SiteState createState() => _Cypher_Icebox_B_SiteState();
}

class _Cypher_Icebox_B_SiteState extends State<Cypher_Icebox_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("4TNAJ9r18o8", "Icebox Cypher B Site Setup 1"),
    VideoData("fIS7M011zIQ", "Icebox Cypher B Site Setup 2"),
    VideoData("HsKLI0Tv2K0", "Icebox Cypher B Site Setup 3"),
    VideoData("OvQcs5ymfwg", "Icebox Cypher B Site Setup 4"),
