...
class Cypher_Lotus_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Cypher_Lotus_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Cypher_Lotus_C_SiteState createState() => _Cypher_Lotus_C_SiteState();
}

class _Cypher_Lotus_C_SiteState extends State<Cypher_Lotus_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("QjBSgUu_tG4", "Lotus Cypher C Site Setup 1"),
    VideoData("dYBD7XJfBZk", "Lotus Cypher C Site Setup 2"),
    VideoData("mGKwFup-D0s", "Lotus Cypher C Site Setup 3"),
  ];
