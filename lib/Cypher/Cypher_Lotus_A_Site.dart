...
class Cypher_Lotus_A_Site extends StatefulWidget {
  ...
  Cypher_Lotus_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Cypher_Lotus_A_SiteState createState() => _Cypher_Lotus_A_SiteState();
}

class _Cypher_Lotus_A_SiteState extends State<Cypher_Lotus_A_Site> {
