...
class Cypher_Abyss_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Cypher_Abyss_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Cypher_Abyss_B_SiteState createState() => _Cypher_Abyss_B_SiteState();
}

class _Cypher_Abyss_B_SiteState extends State<Cypher_Abyss_B_Site> {
