...
class Cypher_Haven_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Cypher_Haven_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Cypher_Haven_B_SiteState createState() => _Cypher_Haven_B_SiteState();
}

class _Cypher_Haven_B_SiteState extends State<Cypher_Haven_B_Site> {
