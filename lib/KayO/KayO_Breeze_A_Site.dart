...
class KayO_Breeze_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Breeze_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Breeze_A_SiteState createState() => _KayO_Breeze_A_SiteState();
}

class _KayO_Breeze_A_SiteState extends State<KayO_Breeze_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("tNIfcbP1haw", "Breeze KayO A Site Default Post Plant Lineup"),
    VideoData("-j3d11nxfRQ", "Breeze KayO A Site Default Post Plant Lineup"),
    VideoData("LQL-uYDNd50", "Breeze KayO Shock Dart Tunnel Chamber Trap Break"),
    VideoData("acXEs1NUwZ4", "Breeze KayO A Back Site Control Recon Dart"),
    VideoData("eWsW-L61b8Q", "Breeze KayO A Site Recon Darts"),
    VideoData("Bxf2eNv--To", "Breeze KayO Mid to B Site Fake Recon Darts"),
    VideoData("JrF-Akn6Mb4", "Breeze KayO Mid to B Mid Door Info Recon Darts"),
    VideoData("pN1Quo7M-s4", "Breeze KayO A Tunnel to A Bridge Info Recon Darts"),
  ];
