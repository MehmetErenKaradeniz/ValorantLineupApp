...
class KayO_Sunset_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Sunset_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Sunset_B_SiteState createState() => _KayO_Sunset_B_SiteState();
}

class _KayO_Sunset_B_SiteState extends State<KayO_Sunset_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("pudlbk_aSfE", "Sunset KayO B Main to B Site Default Post Plant Lineup"),
    VideoData("uOEYi1LZt00", "Sunset KayO B Main to B Enter Cypher Trap Break"),
    VideoData("PLjVWy7OzHE", "Sunset KayO B Main to B Enter Cypher Trap Break 2"),
    VideoData("L-ZOe23FS_M", "Sunset KayO B Main to Mid Double Shock Dart"),
    VideoData("pBHBCGlw4Bs", "Sunset KayO B Main to B Backsite Recon Dart"),
    VideoData("Khfa0m5szTg", "Sunset KayO B Main to B Close Recon Dart"),
