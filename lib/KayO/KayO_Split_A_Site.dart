...
class KayO_Split_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Split_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Split_A_SiteState createState() => _KayO_Split_A_SiteState();
}

class _KayO_Split_A_SiteState extends State<KayO_Split_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("1OF5iTUWDJE", "Split KayO A Main to A Site Post Plant Lineup"),
    VideoData("QDpczW3aLfo", "Split KayO A Main to A Site Back the Box Post Plant Lineup"),
    VideoData("k0DSmcvb9I0", "Split KayO A Main to A Site Open Spike for the Haven Post Plant Lineup"),
    VideoData("Uc6lEhNt3Q", "Split KayO A Main to A Site Recon Dart"),
    VideoData("kmJtLIf22UE", "Split KayO A Main to A Site Recon Dart 2"),
