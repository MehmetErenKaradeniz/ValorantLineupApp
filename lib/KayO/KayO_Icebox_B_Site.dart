...
class KayO_Icebox_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Icebox_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Icebox_B_SiteState createState() => _KayO_Icebox_B_SiteState();
}

class _KayO_Icebox_B_SiteState extends State<KayO_Icebox_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("UBYdgqIvAvY","Icebox KayO B Main to Default Post Plant Lineup"),
    VideoData("3cwzgYQANcw","Icebox KayO B Main to Open Long Post Plant Lineup"),
    VideoData("v_SR-mOgopc","Icebox KayO Spawn to B Long Overpeek check Shock Dart"),
    VideoData("YuCD1zMskLM","Icebox KayO Spawm to Kitchen Recon Dart"),
    VideoData("oY9y050_oek","Icebox KayO B Main to B Site Recon Dart"),
    VideoData("n_g9gMns7Uc","Icebox KayO B Main to B Site Close Control Recon Dart"),
  ];
