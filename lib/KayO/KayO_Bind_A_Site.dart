...
class KayO_Bind_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Bind_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Bind_A_SiteState createState() => _KayO_Bind_A_SiteState();
}

class _KayO_Bind_A_SiteState extends State<KayO_Bind_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("psc7Q24HUJc", "Ascent KayO A Site Default Post Plant Lineup"),
    VideoData("zm_GxXjED1w", "Ascent KayO Box Post Plant Lineup"),
    VideoData("wNobAd8ckTQ", "Ascent KayO B to A Default Double Shock Dart Lineup"),
    VideoData("q8d8NrPIHyY", "Ascent KayO A Site Close Control Recon Dart"),
    VideoData("kqsd8jmBpzM", "Ascent KayO A Backsite Control Recon Dart 2"),
    VideoData("Y8qc1luHeAU", "Ascent KayO Base To A Backsite Recon Dart 3"),
  ];
