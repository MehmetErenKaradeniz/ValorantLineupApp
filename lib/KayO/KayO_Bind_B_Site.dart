...
class KayO_Bind_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Bind_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Bind_B_SiteState createState() => _KayO_Bind_B_SiteState();
}

class _KayO_Bind_B_SiteState extends State<KayO_Bind_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("UTzcXR5HM-4", "Ascent KayO B Site Default Post Plant Lineup"),
    VideoData("wNobAd8ckTQ", "Ascent KayO B to A Default Double Shock Dart Lineup"),
    VideoData("pHwmNGg6cIM", "Ascent KayO Fountain to Side Backsite Recon Dart"),
    VideoData("v_-vgRC79tE", "Ascent KayO Fountain to Side Backsite Recon Dart 2"),
    VideoData("Xac8JP-V_3Q", "Ascent KayO B TP Open Recon/Shock Dart"),
  ];
