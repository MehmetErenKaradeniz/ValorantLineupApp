...
class KayO_Lotus_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Lotus_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Lotus_C_SiteState createState() => _KayO_Lotus_C_SiteState();
}

class _KayO_Lotus_C_SiteState extends State<KayO_Lotus_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("ar545ECEth8", "Lotus KayO C Main to C Open Long Post Plant Lineup"),
    VideoData("nSz5AEh-FZs", "Lotus KayO C Main to C Site Close Control Recon Dart"),
