...
class KayO_Split_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Split_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Split_B_SiteState createState() => _KayO_Split_B_SiteState();
}

class _KayO_Split_B_SiteState extends State<KayO_Split_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("cGmni8QNPS0", "Split KayO B Garage to B Default Post Plant Lineup"),
    VideoData("ta4TJ3GVAfs", "Split KayO B Main to B Default Post Plant Lineup"),
    VideoData("lqrIyTVGPtc", "Split KayO B Main to B Site Recon Dart"),
    VideoData("msDK6AmIuQA", "Split KayO B Main to B Site Recon Dart 2"),
    VideoData("zVUZxF8aRqU", "Split KayO B Main to B Site Recon Dart 3"),
    VideoData("ND1PXlHXx4o", "Split KayO B Main to B Site/Haven Recon Dart 4"),
