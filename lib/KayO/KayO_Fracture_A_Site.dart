...
class KayO_Fracture_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Fracture_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Fracture_A_SiteState createState() => _KayO_Fracture_A_SiteState();
}

class _KayO_Fracture_A_SiteState extends State<KayO_Fracture_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("AA0ks4KScLU", "Fracture KayO A Site Setup 1"),
    VideoData("WIzgiqZgtbw", "Fracture KayO A Site Setup 2"),
    VideoData("Kt_x-BCl0w8", "Fracture KayO A Site Setup 3"),
    VideoData("CCeHO9PoaqY", "Fracture KayO A Site Setup 4"),
  ];
