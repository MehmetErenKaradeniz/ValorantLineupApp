...
class KayO_Ascent_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Ascent_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Ascent_B_SiteState createState() => _KayO_Ascent_B_SiteState();
}

class _KayO_Ascent_B_SiteState extends State<KayO_Ascent_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("-RuvXgq-0Hw", "Ascent KayO B Site Default Post Plant Lineup"),
    VideoData("C8a6Gx0ywtI", "Ascent KayO B Site Default Post Plant Lineup 2"),
    VideoData("nhrW4MqZKRU", "Ascent KayO B Site Recon Dart"),
    VideoData("Y-__Tp2stNI", "Ascent KayO B Site Recon Dart 2"),
    VideoData("LVLe-m4RD1I", "Ascent KayO B Site Spawn to B Recon Dart 3"),
    VideoData("zgbXU70QnP0", "Ascent KayO B to A Recon Fake Recon Dart "),
    VideoData("yk1OXTy7hE4", "Ascent KayO B to A Recon Fake Recon Dart 2"),
  ];
