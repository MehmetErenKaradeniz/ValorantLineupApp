...
class KayO_Breeze_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Breeze_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Breeze_B_SiteState createState() => _KayO_Breeze_B_SiteState();
}

class _KayO_Breeze_B_SiteState extends State<KayO_Breeze_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("-KCqRSMY454","Breeze KayO B Main to B Default Post Plant Lineup"),
    VideoData("c-y6x23hvaU","Breeze KayO B Main to B Site Enter Right Corner Control and Damage Shock Dart"),
    VideoData("c-y6x23hvaU","Breeze KayO B Window to B Site Enter Left Corner Control and Damage Shock Dart"),
    VideoData("zlD2kL0yVvQ","Breeze KayO B Main to A Tunnel Shock Dart Chamber Trap Break"),
    VideoData("W3ITs9KTnbQ","Breeze KayO B Main to B Site Recon Dart"),
    VideoData("8tXFyQfdYuE","Breeze KayO B Main to B Site Recon Dart 2"),
    VideoData("q4PD2UFASMw","Breeze KayO B Window to B Site Recon Dart"),
    VideoData("-uN8_w0Xv-Y","Breeze KayO Near B Window to A Site Fake Recon Dart"),
