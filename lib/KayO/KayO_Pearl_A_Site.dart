...
class KayO_Pearl_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Pearl_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Pearl_A_SiteState createState() => _KayO_Pearl_A_SiteState();
}

class _KayO_Pearl_A_SiteState extends State<KayO_Pearl_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("AA0ks4KScLU", "Pearl KayO A Site Setup 1"),
    VideoData("WIzgiqZgtbw", "Pearl KayO A Site Setup 2"),
    VideoData("Kt_x-BCl0w8", "Pearl KayO A Site Setup 3"),
    VideoData("CCeHO9PoaqY", "Pearl KayO A Site Setup 4"),
  ];
