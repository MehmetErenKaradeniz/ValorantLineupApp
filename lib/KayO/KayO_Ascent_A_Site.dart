...
class KayO_Ascent_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Ascent_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Ascent_A_SiteState createState() => _KayO_Ascent_A_SiteState();
}

class _KayO_Ascent_A_SiteState extends State<KayO_Ascent_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("k4_rVTthzLg", "Ascent KayO A Main to A Default Post Plant Lineup"),
    VideoData("BURUf_1yaBw", "Ascent KayO Wine to A Default Post Plant Lineup"),
    VideoData("RXEmp47eovM", "Ascent KayO Wine to A Double Box Post Plant Lineup"),
    VideoData("6Gli8PIwpTc", "Ascent KayO Generator Check Shock Dart"),
    VideoData("75TLedx4HWI", "Ascent KayO A Site Recon Dart"),
    VideoData("7UGqui8odgU", "Ascent KayO A Site Recon Dart 2"),
    VideoData("j3k3jmpMQ_E", "Ascent KayO A Site Recon Dart 3"),
    VideoData("oluRtvkWIrg", "Ascent KayO A Main to B Fake Recon Dart"),
    VideoData("2C55PQ_PXLA", "Ascent KayO Top Mid(base) to B Fake Recon Dart 2"),
    VideoData("LVLe-m4RD1I", "Ascent KayO Spawn to B Fake Recon Dart 3"),
  ];
