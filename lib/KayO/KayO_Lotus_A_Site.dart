...
class KayO_Lotus_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Lotus_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Lotus_A_SiteState createState() => _KayO_Lotus_A_SiteState();
}

class _KayO_Lotus_A_SiteState extends State<KayO_Lotus_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("LYA--XQ27gU", "Lotus KayO A Main to A Default Post Plant Lineup"),
    VideoData("x7kVgMmp2H8", "Lotus KayO A Main to A Site Recon Dart"),
    VideoData("vniMwInf3JU", "Lotus KayO B Main to A Site Fake Recon Dart"),
