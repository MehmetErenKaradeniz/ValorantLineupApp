...
class KayO_Haven_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  KayO_Haven_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _KayO_Haven_C_SiteState createState() => _KayO_Haven_C_SiteState();
}

class _KayO_Haven_C_SiteState extends State<KayO_Haven_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("QjBSgUu_tG4", "Haven KayO C Site Setup 1"),
    VideoData("dYBD7XJfBZk", "Haven KayO C Site Setup 2"),
    VideoData("mGKwFup-D0s", "Haven KayO C Site Setup 3"),
  ];
