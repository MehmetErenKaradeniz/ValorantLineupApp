...
class Gekko_Haven_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Haven_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Haven_B_SiteState createState() => _Gekko_Haven_B_SiteState();
}

class _Gekko_Haven_B_SiteState extends State<Gekko_Haven_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("hZTcZUJnUWs", "Haven Gekko B Site Setup 1"),
    VideoData("MSM4V3UoOI0", "Haven Gekko B Site Setup 2"),
    VideoData("EfDvNkSNDJU", "Haven Gekko B Site Setup 3"),
  ];
