...
class Gekko_Icebox_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Icebox_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Icebox_B_SiteState createState() => _Gekko_Icebox_B_SiteState();
}

class _Gekko_Icebox_B_SiteState extends State<Gekko_Icebox_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("4TNAJ9r18o8", "Icebox Gekko B Site Setup 1"),
    VideoData("fIS7M011zIQ", "Icebox Gekko B Site Setup 2"),
    VideoData("HsKLI0Tv2K0", "Icebox Gekko B Site Setup 3"),
    VideoData("OvQcs5ymfwg", "Icebox Gekko B Site Setup 4"),
