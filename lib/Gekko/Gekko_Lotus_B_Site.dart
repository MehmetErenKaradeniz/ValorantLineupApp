...
class Gekko_Lotus_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Lotus_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Lotus_B_SiteState createState() => _Gekko_Lotus_B_SiteState();
}

class _Gekko_Lotus_B_SiteState extends State<Gekko_Lotus_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("hZTcZUJnUWs", "Lotus Gekko B Site Setup 1"),
    VideoData("MSM4V3UoOI0", "Lotus Gekko B Site Setup 2"),
    VideoData("EfDvNkSNDJU", "Lotus Gekko B Site Setup 3"),
  ];
