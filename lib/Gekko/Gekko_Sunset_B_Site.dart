...
class Gekko_Sunset_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Sunset_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Sunset_B_SiteState createState() => _Gekko_Sunset_B_SiteState();
}

class _Gekko_Sunset_B_SiteState extends State<Gekko_Sunset_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("qLCrFCuzCjY", "Sunset Gekko B Site Setup 1"),
    VideoData("yfWqvOmEYk8", "Sunset Gekko B Site Setup 2"),
    VideoData("JsavZ-qh2TI", "Sunset Gekko B Site Setup 3"),
  ];
