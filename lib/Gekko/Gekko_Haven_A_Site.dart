...
class Gekko_Haven_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Haven_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Haven_A_SiteState createState() => _Gekko_Haven_A_SiteState();
}

class _Gekko_Haven_A_SiteState extends State<Gekko_Haven_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("wPJWLE1aQjk", "Haven Gekko A Site Setup 1"),
    VideoData("4l-G4LufPm4", "Haven Gekko A Site Setup 2"),
    VideoData("3ZzOz9iBtiQ", "Haven Gekko A Site Setup 3"),
  ];
