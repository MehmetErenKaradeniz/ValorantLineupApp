...
class Gekko_Bind_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Bind_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Bind_B_SiteState createState() => _Gekko_Bind_B_SiteState();
}

class _Gekko_Bind_B_SiteState extends State<Gekko_Bind_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("TxmGWwo7ue8", "Bind Gekko B Site Setup 1"),
    VideoData("Sdhwv6C8hLM", "Bind Gekko B Site Setup 2"),
    VideoData("p2nlZHLpJUA", "Bind Gekko B Site Setup 3"),
    VideoData("-O8oT0kmEkM", "Bind Gekko B Site Setup 4"),
    VideoData("8nbeSKraUKA", "Bind Gekko B Site Setup 5"),
    VideoData("Sdhwv6C8hLM", "Bind Gekko B Site Setup 6"),
  ];
