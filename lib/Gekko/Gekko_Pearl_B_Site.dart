...
class Gekko_Pearl_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Pearl_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Pearl_B_SiteState createState() => _Gekko_Pearl_B_SiteState();
}

class _Gekko_Pearl_B_SiteState extends State<Gekko_Pearl_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("6wxl1WsB8_4", "Pearl Gekko B Site Setup 1"),
    VideoData("0tox9bBpHn4", "Pearl Gekko B Site Setup 2"),
    VideoData("vGy0Rgy7izQ", "Pearl Gekko B Site Setup 3"),
    VideoData("IxgT07FXKuY", "Pearl Gekko B Site Traps"),
  ];
