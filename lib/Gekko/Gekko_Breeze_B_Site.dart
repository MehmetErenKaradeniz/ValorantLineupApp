...
class Gekko_Breeze_B_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Breeze_B_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Breeze_B_SiteState createState() => _Gekko_Breeze_B_SiteState();
}

class _Gekko_Breeze_B_SiteState extends State<Gekko_Breeze_B_Site> {
  List<VideoData> videoDataList = [
    VideoData("8rPEJSIR-PA", "Breeze Gekko B Site Setup 1"),
    VideoData("okzAJn1ZVE4", "Breeze Gekko B Site Setup 2"),
    VideoData("Inoeo6hcx3k", "Breeze Gekko B Site Setup 3"),
    VideoData("QCk0YsZ90bU", "Breeze Gekko B Site Setup 4"),
    VideoData("1BIC2XYwtEY", "Breeze Gekko B Site Setup 5"),
    VideoData("27FtJOnw55c", "Breeze Gekko B Site Setup 6"),
    VideoData("urCytZF4NWg", "Breeze Gekko B Site Setup 7"),
  ];
