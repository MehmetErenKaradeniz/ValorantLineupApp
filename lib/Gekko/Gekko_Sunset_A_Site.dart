...
class Gekko_Sunset_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Sunset_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Sunset_A_SiteState createState() => _Gekko_Sunset_A_SiteState();
}

class _Gekko_Sunset_A_SiteState extends State<Gekko_Sunset_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("QAhwubDrnkE", "Sunset Gekko A Site Setup 1"),
    VideoData("sTYOQ3hFWb4", "Sunset Gekko A Site Setup 2"),
    VideoData("2i5cezzxXXI", "Sunset Gekko A Site Setup 3"),
    VideoData("Vrty3f2Uy_U", "Sunset Gekko A Site Setup 4"),
  ];
