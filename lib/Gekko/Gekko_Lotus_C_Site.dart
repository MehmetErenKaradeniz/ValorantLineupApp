...
class Gekko_Lotus_C_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Lotus_C_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Lotus_C_SiteState createState() => _Gekko_Lotus_C_SiteState();
}

class _Gekko_Lotus_C_SiteState extends State<Gekko_Lotus_C_Site> {
  List<VideoData> videoDataList = [
    VideoData("QjBSgUu_tG4", "Lotus Gekko C Site Setup 1"),
    VideoData("dYBD7XJfBZk", "Lotus Gekko C Site Setup 2"),
    VideoData("mGKwFup-D0s", "Lotus Gekko C Site Setup 3"),
  ];
