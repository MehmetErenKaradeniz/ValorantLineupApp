...
class Gekko_Icebox_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Icebox_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Icebox_A_SiteState createState() => _Gekko_Icebox_A_SiteState();
}

class _Gekko_Icebox_A_SiteState extends State<Gekko_Icebox_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("sIf4CKpMChE", "Icebox Gekko A Site Setup 1"),
    VideoData("F6r7nwsJpvA", "Icebox Gekko A Site Setup 2"),
    VideoData("fq8ZNQvNzdQ", "Icebox Gekko A Site Setup 3"),
    VideoData("lFGX-OekTkw", "Icebox Gekko A Site Setup 4"),
    VideoData("sMmZTJU6fGA", "Icebox Gekko Mid Setup"),
  ];
