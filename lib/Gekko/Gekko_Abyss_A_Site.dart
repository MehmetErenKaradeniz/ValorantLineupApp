...
class Gekko_Abyss_A_Site extends StatefulWidget {
  final AgentsData agent;
  final MapsData map;
  final SiteData site;

  Gekko_Abyss_A_Site({Key? key, required this.agent, required this.map, required this.site}) : super(key: key);

  @override
  _Gekko_Abyss_A_SiteState createState() => _Gekko_Abyss_A_SiteState();
}

class _Gekko_Abyss_A_SiteState extends State<Gekko_Abyss_A_Site> {
  List<VideoData> videoDataList = [
    VideoData("AA0ks4KScLU", "Abyss Gekko A Site Setup 1"),
    VideoData("WIzgiqZgtbw", "Abyss Gekko A Site Setup 2"),
    VideoData("Kt_x-BCl0w8", "Abyss Gekko A Site Setup 3"),
    VideoData("CCeHO9PoaqY", "Abyss Gekko A Site Setup 4"),
  ];
